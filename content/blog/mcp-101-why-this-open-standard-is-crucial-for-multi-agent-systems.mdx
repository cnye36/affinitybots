...
date: 2025-09-04
author: "Curtis Nye"
description: "Explore why the Model Context Protocol (MCP) is crucial for multi-agent systems."
categories:
  - MCP
  - Multi-Agent Systems
  - Open Standards
...
* **Content pipelines:** Research, draft, fact-check, and publish across docs, CMS, and analytics—all exposed as MCP servers so the agents work like a coordinated editorial team. We document this workflow in [Automating Content Creation with AI Agents](/blog/automating-content-creation-with-ai-agents).
